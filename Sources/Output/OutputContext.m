...
//	v0.70
- (FeedpointCache*)feedpointCache:(int)index ;
{
...
//  v0.70
- (void)setFeedpointCache:(FeedpointCache*)feed feedpointNumber:(int)index
{
...
{
	int i, j, count, nextSegment, diff ;
	StructureInfo *g ;
