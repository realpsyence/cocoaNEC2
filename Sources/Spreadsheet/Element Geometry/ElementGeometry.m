...
- (id)initWithDelegate:(id)client type:(int)type
{
	...
	selectedType = type ;
	if ( [ NSBundle loadNibNamed:@"Geometry" owner:self ] == NO ) return nil ; 
...
- (SegmentRange)selectedSegment:(NSMatrix*)matrix segNumber:(NSTextField*)from to:(NSTextField*)to
{
	...
	range.from = range.to = ( segments+1 )/2 ;	
	return range ;
}
...
- (void)addExcitationToDict:(NSMutableDictionary*)base
{
	...
	case 1:
		//  voltage
		[ dict setObject:[ NSNumber numberWithInt:[ exLocationMatrix selectedRow ] ] forKey:@"location" ] ;
	...
	case 2:
		//  current
		[ dict setObject:[ NSNumber numberWithInt:[ curLocationMatrix selectedRow ] ] forKey:@"location" ] ;
...
- (void)addLoadToDict:(NSMutableDictionary*)base
{
	...
	case 1:
		//  series RLC
		[ dict setObject:[ NSNumber numberWithInt:[ seriesLocationMatrix selectedRow ] ] forKey:@"location" ] ;
	...
	case 2:
		//  parallel RLC
		[ dict setObject:[ NSNumber numberWithInt:[ parallelLocationMatrix selectedRow ] ] forKey:@"location" ] ;
	...
	case 3:
		//  impedance
		[ dict setObject:[ NSNumber numberWithInt:[ impedanceLocationMatrix selectedRow ] ] forKey:@"location" ] ;
	...
	case 4:
		//  conductivity
		[ dict setObject:[ NSNumber numberWithInt:[ conductivityLocationMatrix selectedRow ] ] forKey:@"location" ] ;
