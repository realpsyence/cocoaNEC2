...
- (Boolean)generateDeck:(RuntimeStack*)stack
{
	...
	if ( excitations < 1 ) {
		[ [ NSAlert alertWithMessageText:@"No excitation defined." defaultButton:@"OK" alternateButton:nil otherButton:nil informativeTextWithFormat:@"\nYou have not defined any excitation.  The model will not be submitted to NEC-2.\n" ] runModal ] ;
		return NO ;
	}
	return YES ;
}
