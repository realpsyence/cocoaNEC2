...
- (void)setFrom:(NCValue*)v withType:(int)inType
{
	...
	if ( array != nil ) [ array autorelease ] ;
	array = ( [ v array ] != nil ) ? [ [ v array ] retain ] : nil ;
}
...
{
	type = VECTORTYPE ;
	realValue = intValue = (long)vector ;
	if ( vectorValue != nil ) [ vectorValue autorelease ] ;
...
{
	type = TRANSFORMTYPE ;
	realValue = intValue = (long)transform ;
	if ( transformValue != nil ) [ transformValue autorelease ] ;
