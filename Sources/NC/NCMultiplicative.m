...
- (NCValue*)divideByZero
{
	...
	if ( stack != nil ) [ stack->errors addObject:[ NSString stringWithFormat:@"Divide by zero at line %d", line ] ] ;
	else 
	[ [ NSAlert alertWithMessageText:@"Divide by zero seen!" defaultButton:@"OK" alternateButton:nil otherButton:nil informativeTextWithFormat:[ NSString stringWithFormat:@"\nAttempting to perform a division or a mod by zero at line %d.\n", line ] ] runModal ] ;	
