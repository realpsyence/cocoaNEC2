...
void usage(void)
{
  fprintf( stderr,
      ...
      "\n       -j: number of parallel jobs to start in frequency loops."
...
int load_line( char *buff, FILE *pfile )
{
  ...
  if( (buff[0] > 0x60) && (buff[0] < 0x79) ) buff[0] -= 0x20;
  if( (buff[1] > 0x60) && (buff[1] < 0x79) ) buff[1] -= 0x20;
